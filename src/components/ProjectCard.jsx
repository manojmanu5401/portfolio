  ...
  return (
    <>
      <div
        ...
        } rounded-2xl p-6 shadow-[rgba(0,0,0,0.1)_0px_4px_12px]`}
      >
        <div
        ...
        <div className="flex flex-col items-center pt-5">
          <h2 className="font-bold text-xl">{project.proName}</h2>
          <p className="max-w-md font-medium text-center mt-6">
          ...
          <div className="flex flex-wrap gap-8 mt-10">
            {project.gitHub && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="text-xl flex align-center gap-2"
              >
