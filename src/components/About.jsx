...
export default function About() {
  return (
    <>
      <section className="mx-auto max-w-7xl pt-44 py-4 px-4 sm:px-6 lg:px-8 dark:bg-[#191919]" id="about">
        <div className="mx-5 xl:mx-24">
          <div className="flex flex-col justify-center text-center lg:text-start items-center lg:flex-row lg:space-x-10 h-max space-y-10">
            ...
            <div>
            <h1 className="relative text-4xl lg:text-start font-bold dark:text-gray-400">About me</h1>
            <h6 className="text-[#F3A3A5] font-medium mt-2">My Introduction</h6>
            <p className="mt-6 text-md text-justify dark:text-gray-500">
